#############################################################################
# Makefile for building: BurgerQuiz.exe
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = BurgerQuiz.exe1.0.0
DISTDIR = /home/isen/Documents/Burguer-Quiz/.tmp/BurgerQuiz.exe1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lmysqlcppconn -lQt5Widgets -lQt5Gui -lQt5Sql -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
